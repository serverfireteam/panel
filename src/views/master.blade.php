...
<head>
    ...
    <link media="all" type="text/css" rel="stylesheet" href="{{asset("packages/packages/zofe/rapyd/assets/demo/style.css")}}">    
    <link media="all" type="text/css" rel="stylesheet" href="{{asset("packages/packages/zofe/rapyd/assets/redactor/css/redactor.css")}}">
    <link media="all" type="text/css" rel="stylesheet" href="{{asset("packages/packages/zofe/rapyd/assets/datepicker/datepicker3.css")}}">
    <link media="all" type="text/css" rel="stylesheet" href="{{asset("packages/packages/zofe/rapyd/assets/autocomplete/autocomplete.css")}}">
    <link media="all" type="text/css" rel="stylesheet" href="{{asset("packages/packages/zofe/rapyd/assets/autocomplete/bootstrap-tagsinput.css")}}">
